      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#" className="hover:text-primary transition-colors">HDPE Drums</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Storage Containers</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Specialty Jars</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Custom Solutions</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Food Grade Products</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-muted-foreground">sales@goodwillplast.com</span>
              </div>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © 2024 GoodWill Plast. All rights reserved.
          </p>
